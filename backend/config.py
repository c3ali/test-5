...
```bash
# .env.example - Copier ce fichier en .env et personnaliser les valeurs

# Environnement
ENVIRONMENT=development
DEBUG=True
APP_NAME=MonAPI
SECRET_KEY=votre-clé-secrète-super-sécurisée-ici
...
POSTGRES_PORT=5432
POSTGRES_DB=monapi_dev
# Ou directement : DATABASE_URL=postgresql://user:pass@localhost:5432/dbname
...
### Utilisation dans votre application FastAPI :
...
Ce fichier de configuration offre :
- ✅ Validation des types avec Pydantic
- ✅ Valeurs par défaut sécurisées
- ✅ Support multi-environnements
- ✅ Construction automatique des URLs
- ✅ Secrets masqués et validation en production
- ✅ Compatible avec l'injection de dépendances FastAPI
- ✅ Flexible et extens